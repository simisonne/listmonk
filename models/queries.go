...
type Queries struct {
	...
	GetDashboardEvents *sqlx.Stmt `query:"get-dashboard-events"`
	...
	GetCampaignSubscriberStats *sqlx.Stmt `query:"get-campaign-subscriber-stats"`
	...
	UpdateCampaignName       *sqlx.Stmt `query:"update-campaign-name"`
